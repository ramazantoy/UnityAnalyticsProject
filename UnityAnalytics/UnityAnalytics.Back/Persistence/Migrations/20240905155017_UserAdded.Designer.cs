...
namespace UnityAnalytics.Back.Persistence.Migrations
{
    ...
    [Migration("20240905155017_UserAdded")]
            ...
            modelBuilder.Entity("UnityAnalytics.Back.Core.Domain.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d1ebcafc-85a1-4c6d-a0ad-c23f7267fc9c"),
                            AppRoleId = 1,
                            CreatedAt = new DateTime(2024, 9, 5, 18, 50, 17, 425, DateTimeKind.Local).AddTicks(6887),
                            Password = "leonbrave",
                            UserName = "leonbrave"
                        });
                });
